...
DONKEY_GYM = False
DONKEY_SIM_PATH = "F:/MyPrograms/projects/DonkeySimWin/donkey_sim.exe" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
...
GPS_SERIAL = '/dev/ttyS0' # serial device path, like '/dev/ttyAMA1' or '/dev/ttyUSB0'
...
PATH_MIN_DIST = 0.0                 # after travelling this distance (m), save a path point
...
PATH_LOOK_BEHIND = 3                # number of points behind the closest point to include in cte track   
...
RESET_ORIGIN_BTN = None     # button to press to move car back to origin
ERASE_PATH_BTN = "web/w3"     # button to erase path
TOGGLE_RECORDING_BTN = None # button to toggle recording mode
...
INC_PID_P_BTN = "web/w4"            # button to change PID 'P' constant by PID_P_DELTA
DEC_PID_P_BTN = "web/w5"            # button to change PID 'P' constant by -PID_P_DELTA
...
#超声波传感器HC-SR04
RANGE_TRIG_GPIO = 23     #触发引脚
RANGE_ECHO_GPIO = 24     #回声引脚
RANGE_GPIOS = [
    RANGE_TRIG_GPIO,
    RANGE_ECHO_GPIO
]
USE_ULTRASONIC = False  #启用避障
MIN_DISTANCE = 0    #避障距离
MIN_DISTANCE_START = 0  #启动最小距离